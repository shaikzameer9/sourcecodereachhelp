...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <script>
        ...
        function getActiveOffers(searchVal) {
            $.appPost("./index.aspx/getActiveOffers", { categoryId: 0, startValue: 0, noOfRows: 10, searchVal: searchVal }).then(function (resp) {
